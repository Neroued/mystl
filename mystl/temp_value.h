...
struct __temp_value {
    ...
    _MYSTL_CONSTEXPR_SINCE_CXX20 _Tp* __addr() {
        return std::addressof(__v);
    }

    _MYSTL_CONSTEXPR_SINCE_CXX20 _Tp& get() {
        return *__addr();
    }
    ...
    _MYSTL_CONSTEXPR_SINCE_CXX20 ~__temp_value() {
        alloc_traits::destroy(__alloc_, __addr());
    }
};
